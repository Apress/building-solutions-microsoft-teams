...
3. Give the bot a handle (ex: `getBooksBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://messagingextension.azurewebsites.net/api/messages`
