# Task Modules Bot - `taskModulesBot`
...
3. Give the bot a handle (ex: `taskModulesBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://taskmodulesbot.azurewebsites.net/api/messages`
