...
3. Give the bot a handle (ex: `searchCmdBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://yoteamsmessagingextension.azurewebsites.net/api/messages`
