...
export interface IMyTeamTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IMyTeamTabRemoveProps {

}

/**
 * Implementation of My Team Tab remove page
 */
export class MyTeamTabRemove  extends TeamsBaseComponent<IMyTeamTabRemoveProps, IMyTeamTabRemoveState> {
