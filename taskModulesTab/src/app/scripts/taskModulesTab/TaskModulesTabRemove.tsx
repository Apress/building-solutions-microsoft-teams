...
export interface ITaskModulesTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITaskModulesTabRemoveProps {

}

/**
 * Implementation of Task Modules remove page
 */
export class TaskModulesTabRemove  extends TeamsBaseComponent<ITaskModulesTabRemoveProps, ITaskModulesTabRemoveState> {
